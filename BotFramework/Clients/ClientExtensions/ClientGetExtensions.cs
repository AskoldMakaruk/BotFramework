...
namespace BotFramework.Clients.ClientExtensions
{
    ...
    {
        public static async Task<Message> GetTextMessage(this IClient client)
        {
            var update = await client.GetUpdate(u => !string.IsNullOrEmpty(u.Message?.Text));
            return update.Message;
        }
        public static async Task<Message> GetOnlyButtonResult(this IClient client, ReplyKeyboardMarkup replyMarkup)
        {
